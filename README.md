...
- **Zero live-infrastructure tests** — all 72 tests use `unittest.mock` to patch HTTP responses; Docker is never required to run the test suite
...
**72 tests passing.** Tests do not require Docker or a running network target.
